...
const quickActions = [
  ...
  { icon:'📚', bg:'#2e1e3a', label:'Past Questions', sub:'Entrance exam past questions', path:'/past-questions' },
    ...
    <div style={s.page}>
      ...
      <div style={{ ...s.body, paddingBottom:'5rem' }}>
        ...
        <div style={s.heroBanner}>
          <div style={s.heroLabel}>🏫 NURSING SCHOOLS ENTRANCE EXAM</div>
          ...
          <div style={s.mockCard}>
            ...
            <div>
              ...
              <div style={s.mockSub}>Simulate a real Post-UTME entrance exam under timed conditions. Tests your full readiness.</div>
            </div>
          </div>

          <div style={s.heroButtons}>
            <button style={s.startBtn} onClick={() => navigate('/mock')}>▶ Start Exam</button>
            <button style={s.continueBtn} onClick={() => navigate('/mock')}>⏸ Continue</button>
          </div>
        </div>
